...
{
    public class WaferMarkingController : CommonProductionController
    {
        ...
        public JsonResult GetEquipments()
        {
            ...
            var data = db.Queryable<RMS_EQUIPMENT>().Where(it => it.TYPE == "WaferMarking").ToList();
            ...
            try
            {
                ...
                if (SendMessageToSfis(sfis_step7_req, ref sfis_step7_res, ref errmsg))
                {
                   ...
                   .ToDictionary(keyValueArray => keyValueArray[0], keyValueArray => keyValueArray[1]);
                        ...
                        string targetPath = "/ProductionDPSLaserMark";
                        //Sftp清空文件夹

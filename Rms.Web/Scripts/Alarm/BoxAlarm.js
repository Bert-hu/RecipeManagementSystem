...
layui.use(['layer', 'table', 'form', 'upload'], function () {
    ...
    var alarmtable = table.render({
        ...
        , cols: [[
            ...
            , { field: 'ALARM_CODE', title: 'ALARM_CODE', width: '18%' }
            , { field: 'LEVELS', title: 'LEVELS', width: '12%', edit: 'text' }
            , { field: 'TYPE', title: 'TYPE', width: '12%', edit: 'text' }

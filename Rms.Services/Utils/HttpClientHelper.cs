...
namespace Rms.Services.Utils
{
    public class HTTPClientHelper
    {
        ...
        public static string GetResponseBySimpleGetWithUserPassword(string strUserName, string strPassword, string strUrl)
        {
            ...
            var result = httpclient.GetStringAsync(strUrl).Result;
            return result;
        }
